	...
	return (
		...
		<div className='rotate-message'>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
				<path d="M8.2 2.1c2.5.1 5.1-.1 7.6.1.5.1.9.5 1 1-.1 6.2.1 12.5-.1 18.7-.1.5-.5.9-1 1-2.5-.1-5.1.1-7.6-.1-.5-.1-.9-.5-1-1 .1-6.2-.1-12.5.1-18.7.1-.5.5-.9 1-1"/>
				<path d="M10.1 20.2c1.2-.1 2.5.1 3.7-.1" />
			</svg>
