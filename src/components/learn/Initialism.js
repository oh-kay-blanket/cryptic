	...
	return(
		<div className='learn container'>
			...
			<div className='learn-section'>
				<h2>Initialism</h2>
				<p>Use first (or last, or even middle) letters of series of words.</p>
				<p className='example'>sights that astronomers really savor → stars</p>
			</div>
