					...
					<div className='example-container'>
						...
						<div className='explanation dark:!bg-neutral-700 dark:!text-neutral-100'>
							<ul className='mt-0 list-disc my-3'>
								...
								<li>
									<strong>starts late</strong> indicates a deletion
								</li>
							</ul>
							<p className='text-center'>
								<strong>mother</strong> - <strong>m</strong> ={' '}
								<strong>other</strong>
							</p>
					...
					<div className='example-container'>
						...
						<div className='explanation dark:!bg-neutral-700 dark:!text-neutral-100'>
							<ul className='mt-0 list-disc my-3'>
								...
								<li>
									<strong>excluding</strong> indicates a deletion
								</li>
							</ul>
							<p className='text-center'>
								<strong>park is</strong> - <strong>k</strong> ={' '}
								<strong>paris</strong>
							</p>
							<div className='solution'>
