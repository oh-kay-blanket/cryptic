	...
	const resources = [
		{
			...
			items: [
				...
				},
				{
					...
					description:
						'Free daily cryptic crosswords from The Independent newspaper.',
				},
			],
		},
		{
			...
			items: [
				{
					name: 'Minute Cryptic',
					url: 'https://www.minute-cryptic.com',
					description: 'Daily cryptic crosswords with hints and solutions.',
				},
				{
					name: 'Crossword Unclued',
					url: 'https://crosswordunclued.com',
					description:
						'Comprehensive blog about cryptic crosswords with solving tips, setter interviews, and puzzle analysis.',
				},
				{
					name: 'Fifteensquared',
				...
				{
					name: "Big Dave's Crossword Blog",
					url: 'https://bigdave44.com',
					description:
						'Daily hints and solutions for Telegraph cryptic crosswords, plus solving tips and community discussions.',
				},
			],
		},
		{
		...
		},
		{
			...
			items: [
				...
				{
					name: 'Private Eye',
					url: 'https://www.privateeye.co.uk/crosswords/',
					description:
						'Satirical magazine featuring challenging cryptic crosswords with a humorous twist.',
				},
				{
					name: '1 Across Magazine',
					url: 'https://www.1across.org',
					description:
						'Quarterly magazine dedicated entirely to cryptic crosswords, featuring puzzles from top setters worldwide.',
				},
			],
		},
		{
		...
		<Layout>
			<div className='resources lc-container'>
				<h1 className='text-4xl font-bold text-center mb-8'>
					Cryptic Crossword Resources
				</h1>
				<p className='text-lg text-center mb-12 max-w-3xl mx-auto'>
					Ready to dive deeper into the world of cryptic crosswords? Here are
					our recommended resources for finding more puzzles, improving your
					solving skills, and connecting with the cryptic community.
				</p>
				...
				<div className='getting-started bg-neutral-100 dark:bg-neutral-800 rounded-lg p-8 mt-16 border border-neutral-200 dark:border-neutral-700'>
					...
					<p className='text-lg mb-6 text-center max-w-2xl mx-auto'>
						If you're just starting your cryptic crossword journey, we recommend
					...
					<div className='steps grid gap-4 md:grid-cols-3 mb-8'>
						<div className='step text-center'>
							...
							<p className='text-sm text-neutral-600 dark:text-neutral-300'>
								Start with our Learn section to understand cryptic clue types
								and conventions.
							</p>
						</div>
						...
						<div className='step text-center'>
							...
							<p className='text-sm text-neutral-600 dark:text-neutral-300'>
								Solve our daily clues and explore Kegler's archive for more
								practice puzzles.
							</p>
						</div>
						...
						<div className='step text-center'>
							...
							<p className='text-sm text-neutral-600 dark:text-neutral-300'>
								Connect with other solvers through forums and communities to
